...
* Introduction
  ...
  - Beta denudation, reduction of the beta phase, seen in some surface
    samples of Ti-64.
  - This microstructural degradation increases potential for failure.
  - Detection usually a manual process, involving measurement by hand or macro.
  - Automation will provide a quick and useful "second
    opinion" to guide judgement of whether a sample is beta
    denudated or not, taking into account historical data.
  #+REVEAL_HTML: </div>
...
* Extraction of Volume fraction
  ...
  [[file:figures/analyse_data_surface_detection_and_data_extraction_heavily_denudated.png]]
  [[file:figures/analyse_data_surface_detection_and_data_extraction_imageJ_chrisanalysis_first_sideways.png]]
  [[file:figures/analyse_data_surface_detection_and_data_extraction_I038897_heavily_denudated.png]]
...
* Conclusion
  - Efficiencies introduced in detection of beta denudation.
    - Can analyse a batch of images together
